...
function ModalMenuList () {
    const { showModalMenuListId, refProjectCancel, handleDeleteProject, handleRenameProject, projectEditTitle } = useContext(settingsContext);
    ...
    return (
        ...
        >
            <MenuUl>
                <MenuList>
                    <MenuListBtn
                    onClick={() => handleRenameProject(showModalMenuListId)}
                    >
                        <MenuListImg>
